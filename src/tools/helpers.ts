 ...
 */
export function coordinateInPolygon(coordinate: Coordinate, encodedPolygon: string): boolean {
 ...
 */
export function zonedTimeToUtc(isoDateLocalString: string, timezone: string): Date {
